...
def room_1():
    print("Estás en un cuarto grande con las paredes cuviertas de sangre.")
    print("Está demasiado oscuro y lo único que puedes ver son tres puertas")
    print("Conducen al este, norte y oeste. ¿A dónde te diriges?")
    ...
    if "oeste" in choice:
        ...
        game_over("""Cuidadosamente caminas hacia el pasaje que te dirige al este. Después de caminar durante tres minutos, ves que
termina con una pared sólida. Te das la vuelta para volver
pero te encuentras frente a otra pared. Algo ha pasado,
estás atrapado. Sin comida ni agua mueres en unos cuantos días.""")
    else:
        room_1()
...
def room_2():
    print("Esta habitación tiene un techo muy bajo y debes agacharte para caminar.")
...
se vuelve más y más brillante, hasta que no puede ver nada.
...
def room_3():
    ...
    if beast_alive:
        print("Cuando entras a la habitación, entiendes de dónde viene el olor.")
        print("El piso está cubierto de cadáveres podridos.")
        ...
        print("un esqueleto sosteniendo una espada y un agujero en el otro extremo de la habitación.")
...
bestia. Salta hacia atrás con miedo, tropieza y cae en el
agujero, desapareciendo de la habitación.""")
            beast_alive = False
            room_3()
        elif "espada" in choice:
            print("""Tomas la espada. De repente, comienza a emanar una luz y te sientes invencible. Sin saber cómo, tú
...
una buena idea, sin embargo empiezas a caer en el vacío. Mueres días después, todavía
que cayendo.""")
        elif "sur" in choice:
            room_2()
        else:
...
Te sientes estúpido y lo dejas.""")
            room_3()
        elif "espada" in choice:
...
def room_4():
    ...
    if dragon_alive:
        ...
        print("La habitación es enorme, y por buenas razones. Es el hogar de un dragón.")

        if sword:
            print("""De repente, tu espada comienza a brillar. Una fuerza desconocida te impulsa a saltar hacia adelante e introducir la espada en el corazón del dragones.
Muere con horribles gritos.""")
            dragon_alive = False
            room_4()
        else:
            print("Hay un pasaje hacia el norte, uno hacia el este, uno hacia el")
            print("sur y uno al oeste. ¿Qué haces?")

        choice = input("> ")

        game_over("El dragón salta delante de ti y te asa vivo.")
